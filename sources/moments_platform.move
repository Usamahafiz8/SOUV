module souv::souv_platform {
    ...
    public struct Platform<phantom T> has key {
        id: UID,
    }
    ...
    public fun mint_and__transfer<T: drop>(
        ...
        transfer::transfer(souv, recipient);
    }
    ...
    public fun transfer_platform_nft_by_admin<T: drop>(
        _admin: &AdminCap,
        souv: Platform<T>,
        event: &Event<T>,
        recipient: address,
    ...
    public fun transfer_platform_nft_by_sig<T>(
        recipient: address,
        nfts: Platform<T>,
